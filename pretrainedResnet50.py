...
from torchvision.models import ResNet50_Weights  # Import pretrained weights for ResNet50
...
plt.savefig("pretrained_Confussion_Matrix.jpeg", bbox_inches="tight")
plt.close()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig("pretrainedTraining_Validation_Loss", bbox_inches="tight")
plt.close()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig("pretrainedTraining_Validation_Accuracy_jpeg", bbox_inches="tight")
plt.close()

print("Plots saved as images: 'pretrained_Confussion_Matrix.jpeg', 'pretrainedTraining_Validation_Loss', 'pretrainedTraining_Validation_Accuracy_jpeg'")
